...
argument-hint: "<course-slug> [<lesson-range>]  (ej: Codex-with-the-anthropic-api 9-25)"
---
...
1. **Playwright MCP instalado** en Codex:
   ```bash
...
- El link del curso (ej. `/Codex-with-the-anthropic-api`).
...
- **URL con ID** tras hacer click (ej. `/Codex-with-the-anthropic-api/287724`).
